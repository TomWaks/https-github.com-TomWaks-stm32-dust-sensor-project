...
void SSD1306::init_display(){
    speed(SSD1306::Medium);
    init();
    cls();    
}
void SSD1306::setConfigView(){
     locate(2,0); 
     printf(" Prosze czekac!");
     locate(4,0); 
     printf(" Trwa niezbedna");
     locate(5,0); 
     printf("  konfiguracja ");
     locate(6,0); 
     printf("    czujnika   ");
     line(  0,  0, 127,  0, SSD1306::Normal); 
     line(127,  0, 127, 63, SSD1306::Normal); 
     line(127, 63,   0, 63, SSD1306::Normal);
     line(  0, 63,   0,  0, SSD1306::Normal);
     fill(0, 0);
     redraw(); 
}

void SSD1306::setTimeAndWaitView(string time){
    cls();   
    locate(1, 1);
    printf("%s", time.c_str());
    locate(4, 0);
    ...
    printf("Trwa pomiar");
    line(0,    0, 127,  0, SSD1306::Normal);
    line(0,    1, 127,  1, SSD1306::Normal);
    line(0,   21, 127, 21, SSD1306::Normal);
    line(0,   22, 127, 22, SSD1306::Normal);
    line(127,  0, 127, 21, SSD1306::Normal);
    line(126,  0, 126, 21, SSD1306::Normal);
    line(0,   21,   0,  0, SSD1306::Normal);
    line(1,   21,   1,  0, SSD1306::Normal); 
    line(127,  0, 127, 63, SSD1306::Normal); 
    line(127, 63,   0, 63, SSD1306::Normal);
    line(  0, 63,   0,  0, SSD1306::Normal);
...
void SSD1306::setTimeView(string time){ 
    locate(1, 1);
    printf("%s", time.c_str());
    line(0,    0, 127,  0, SSD1306::Normal);
    line(0,    1, 127,  1, SSD1306::Normal);
...
void SSD1306::setNoWifiAndWaitView(){
    cls();
    locate(1, 0);
    printf("   BRAK WIFI   ");
    locate(4, 0);
...
void SSD1306::setInterruptInfo(int n1, int n2, int n3){
    cls(); 
    locate(4,0); 
    printf(" Time meas: %2ds", n1);
    locate(5,0); 
    printf(" Numb meas: %2d", n2);
    locate(6,0); 
    printf(" Break Time: %2ds ", n3);
    line(  0,  0, 127,  0, SSD1306::Normal); 
    line(127,  0, 127, 63, SSD1306::Normal); 
    line(127, 63,   0, 63, SSD1306::Normal);
    line(  0, 63,   0,  0, SSD1306::Normal);
...
void SSD1306::viewInfoDust(int pm2_5, int pm10)
{
    if(pm2_5 <10) {
        locate(4, 0);
        printf(" PM2.5   %dug/m3", pm2_5);
    }

    if(pm10 <10) {
        locate(6, 0);
        printf(" PM10    %dug/m3", pm10);
    }

    if(pm2_5>9 && pm2_5<100) {
        locate(4, 0);
        printf(" PM2.5  %dug/m3", pm2_5);
    }
    ...
    if(pm2_5>99 && pm2_5<1000) {
        locate(4, 0);
        printf(" PM2.5 %dug/m3", pm2_5);
    }

    if(pm10>99 && pm10<1000) {
        locate(6, 0);
        printf(" PM10  %dug/m3", pm10);
    }
    ...
    line(0, 0, 127, 0, SSD1306::Normal);
    line(0,63, 127, 63, SSD1306::Normal);
    line(127, 0, 127, 63, SSD1306::Normal);
    line(0, 0, 0, 63, SSD1306::Normal);
    fill(0, 0);
    redraw();
}
    
    
void SSD1306::viewInfoParametrs(float t, float p, float h)
{

    locate(4, 0); 
    printf(" Temp: %4.2f'C ", t); 
    locate(5, 0);
    printf(" Pres:%4.2fhPa", p);
    locate(6, 0);
    printf(" Humi: %4.2f%%   ", h);
    locate(7, 0);
    printf("              ");
