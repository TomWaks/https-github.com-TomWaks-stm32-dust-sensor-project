...
public:
    ...
    /** custom functions are created by TomWaks **/
    void init_display();
    void setConfigView();
    void setTimeAndWaitView(string time);
    void setTimeView(string time);
    void setNoWifiAndWaitView();
    void setErrorCardView();
    void setInterruptInfo(int n1, int n2, int n3);
    void setErrorMeas();
    void viewInfoDust(int pm2_5, int pm10);
    void viewInfoParametrs(float t, float p, float h);
